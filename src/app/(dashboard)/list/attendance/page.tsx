...
const PageHeader = ({ role }: { role: string }) => (
  <div className="mb-8">
    <h1 className="text-lg font-bold text-gray-900 dark:text-white">Absensi Kelas</h1>
    <p className="mt-2 text-gray-600 dark:text-white">
      {role === "admin" 
        ? "Melihat dan mengelola kehadiran untuk semua kelas" 
        : "Lihat kehadiran untuk kelas yang Anda tetapkan"}
    </p>
  </div>
);

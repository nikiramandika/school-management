...
const StudentTable = ({
  ...
  const handleDownloadPDF = async () => {
    ...
    doc.setFontSize(10);
    doc.text(`Kelas: ${selectedAssessmentDetails.class.grade?.level === 1 ? "X" : selectedAssessmentDetails.class.grade?.level === 2 ? "XI" : "XII"} ${selectedAssessmentDetails.class.name}`,
      14, 44);
    doc.text(

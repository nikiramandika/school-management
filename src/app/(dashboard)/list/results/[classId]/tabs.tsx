...
const Tabs = ({ classId, className, totalExams = 0, totalAssignments = 0 }: TabsProps) => {
            ...
            >
              ...
              <Badge 
                ...
                className={cn(
                  ...
                  tab.color === 'purple' && 'bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300',
                  tab.color === 'orange' && 'bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300'
                )}
              >
                {tab.count}
              </Badge>

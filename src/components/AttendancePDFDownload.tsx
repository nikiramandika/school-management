...
export function AttendancePDFDownload({
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      doc.setFontSize(10);
      doc.text(`Mata Pelajaran: ${lesson.name}`, 14, 44);
      doc.text(`Guru: ${lesson.teacher.name} ${lesson.teacher.surname}`, 14, 50);
      doc.text(
      ...
      doc.text(`Tanggal Download: ${new Date().toLocaleDateString("id-ID")}`, 14, 62);

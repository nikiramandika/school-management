          ...
          <div className="flex justify-center">
            <Calendar
              ...
              classNames={{
                ...
                nav_button: "h-9 w-9 bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-full shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed",
                nav_button_previous: "absolute left-2",
                nav_button_next: "absolute right-2",
                table: "w-full border-collapse space-y-1 mt-2",
                head_row: "flex mb-2",
                head_cell: "text-gray-500 dark:text-gray-400 rounded-lg w-10 font-semibold text-sm uppercase tracking-wider",
                ...
                day: "h-10 w-10 p-0 font-medium aria-selected:opacity-100 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-all duration-200 hover:scale-105",
                day_range_end: "day-range-end",
                day_selected: "bg-gradient-to-br from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 focus:from-indigo-600 focus:to-purple-700 shadow-lg font-bold transform scale-105",
                day_today: "bg-gradient-to-br from-orange-400 to-red-500 text-white font-bold border-2 border-orange-300 shadow-lg transform scale-105",
                day_outside: "day-outside text-gray-400 opacity-40 dark:text-gray-500",
                day_disabled: "text-gray-400 opacity-40 dark:text-gray-500 cursor-not-allowed",

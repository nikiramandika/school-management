...
const BigCalendar = ({
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (nowIndicator) {
        ...
        if (
          ...
          setShowTooltip(true);
          setTooltipPosition({
            top: rect.top - 110, // naikkan tooltip di atas garis
            left: rect.left - 190, // center tooltip secara horizontal
          });
        } else {
  ...
  return (
    <div className="h-[603px] relative shadow-md rounded-[10px]">
      <style jsx global>{`
        .fc {
          --fc-border-color: ${resolvedTheme === "dark"
            ? "rgba(55, 65, 81, 0.3)"
            : "rgba(229, 231, 235, 0.5)"};
          --fc-button-text-color: ${resolvedTheme === "dark" ? "#f8fafc" : "#1e293b"};
          --fc-button-bg-color: ${resolvedTheme === "dark"
            ? "rgba(30, 41, 59, 0.8)"
            : "rgba(255, 255, 255, 0.9)"};
          --fc-button-border-color: ${resolvedTheme === "dark"
            ? "rgba(55, 65, 81, 0.5)"
            : "rgba(203, 213, 225, 0.6)"};
          --fc-button-hover-bg-color: ${resolvedTheme === "dark"
            ? "rgba(51, 65, 85, 0.9)"
            : "rgba(248, 250, 252, 0.95)"};
          --fc-button-hover-border-color: ${resolvedTheme === "dark"
            ? "rgba(75, 85, 99, 0.8)"
            : "rgba(148, 163, 184, 0.7)"};
          --fc-button-active-bg-color: linear-gradient(
            135deg,
            #3b82f6,
            #1d4ed8
          );
          ...
          --fc-today-bg-color: ${resolvedTheme === "dark"
            ? "rgba(59, 130, 246, 0.05)"
            : "rgba(59, 130, 246, 0.03)"};
          --fc-neutral-bg-color: ${resolvedTheme === "dark"
            ? "rgba(15, 23, 42, 0.95)"
            : "rgba(255, 255, 255, 0.98)"};
          --fc-list-event-hover-bg-color: ${resolvedTheme === "dark"
            ? "rgba(51, 65, 85, 0.6)"
            : "rgba(248, 250, 252, 0.8)"};
          --fc-highlight-color: ${resolvedTheme === "dark"
            ? "rgba(59, 130, 246, 0.1)"
            : "rgba(59, 130, 246, 0.05)"};
          --fc-page-bg-color: ${resolvedTheme === "dark" ? "#0f172a" : "#ffffff"};
          --fc-neutral-text-color: ${resolvedTheme === "dark" ? "#e2e8f0" : "#334155"};
          --fc-more-link-bg-color: ${resolvedTheme === "dark"
            ? "rgba(51, 65, 85, 0.8)"
            : "rgba(248, 250, 252, 0.9)"};
          --fc-more-link-text-color: ${resolvedTheme === "dark"
            ? "#e2e8f0"
            : "#475569"};
          ...
          --fc-non-business-color: ${resolvedTheme === "dark"
            ? "rgba(15, 23, 42, 0.8)"
            : "rgba(248, 250, 252, 0.6)"};
          --fc-bg-event-color: ${resolvedTheme === "dark"
            ? "rgba(51, 65, 85, 0.4)"
        ...
        .fc .fc-button:hover {
          ...
          border-color: ${resolvedTheme === "dark"
            ? "rgba(96, 165, 250, 0.6)"
            : "rgba(59, 130, 246, 0.4)"};
        }
        ...
        .fc .fc-timegrid-slot-label {
          ...
          padding: 0.75rem;
          text-shadow: ${resolvedTheme === "dark"
        ...
        .fc .fc-timegrid-now-indicator-line {
          ...
          z-index: 10;
          cursor: pointer;
          box-shadow: 0 0 20px rgba(0, 187, 167, 0.4);
        ...
        @keyframes pulse-green {
          ...
          50% {
            box-shadow: 0 0 30px rgba(0, 187, 167, 0.6);
          }
        }
        ...
        .fc .fc-timegrid-now-indicator-arrow {
          ...
          z-index: 10;
          cursor: pointer;
          filter: drop-shadow(0 2px 4px rgba(0, 187, 167, 0.3));
        }
        ...
        .now-indicator-tooltip {
          ...
          opacity: 0;
          transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
          box-shadow: 0 10px 25px -5px rgba(0, 187, 167, 0.4),
      ...
      <div
        ...
        style={{
          ...
          transform: "translate(115%, 180%)", // center horizontal & posisikan tepat di atas
          whiteSpace: "nowrap",
        }}
      >
        Waktu Sekarang

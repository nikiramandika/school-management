    ...
    <div className="h-[603px] relative shadow-md rounded-[10px]">
      <style jsx global>{`
        .fc {
          ...
          --fc-button-bg-color: ${theme === "dark"
            ? "rgba(30, 41, 59, 0.8)"
            : "rgba(255, 255, 255, 0.9)"};
          --fc-button-border-color: ${theme === "dark"
            ? "rgba(55, 65, 81, 0.5)"
          ...
          --fc-non-business-color: ${theme === "dark"
            ? "rgba(15, 23, 42, 0.8)"
            : "rgba(248, 250, 252, 0.6)"};
          --fc-bg-event-color: ${theme === "dark"
            ? "rgba(51, 65, 85, 0.4)"
      ...
      <div
        ...
        style={{
          ...
          transform: "translate(-50%, -100%)", // center horizontal & posisikan tepat di atas
          whiteSpace: "nowrap",
        }}
      >
        Waktu Sekarang
